...
Team project built at a hackathon on one laptop. Just HTML, CSS, and vanilla JavaScript — no framework needed. We used Claude (an AI assistant by Anthropic) to help with coding and debugging.

## Team

Built by SF State students. We each took turns on the laptop while the others researched content, tested the app, and figured out what students actually need to know.

## Acknowledgments

- AI coding assistance by Claude (Anthropic)
- Content sourced from SF State's official offices
